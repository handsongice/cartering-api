 ...
 */
@Slf4j
public class PoiExcelExportUtil<T> {
    /**
     * excel导出名称
     */
     ...
     * 构造函数
     */
    public PoiExcelExportUtil(String fileName, String[] heads, String[] cols, List<T> list, OutputStream out) {
    ...
    // 构造函数 带数字类型
    public PoiExcelExportUtil(String fileName, String[] heads, String[] cols, List<T> list, int[] numerics, OutputStream out) {
        this.fileName = fileName;
        this.heads = heads;
        this.cols = cols;
        this.list = list;
